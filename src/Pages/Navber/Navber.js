      ...
      <header aria-label="Site Header" class="shadow-sm lg:py-5">
        <div class="mx-auto flex h-16 max-w-screen-xl items-center justify-between px-4">
          ...
          <div class="lg:flex items-center gap-4 hidden cursor-pointer">
            ...
            <div
              className="mt-4 text-2xl text-start uppercase font-bold bg-yellow-600 text-white p-11 z-50 "
              style={{ clipPath: "polygon(-5px 0px, 82% 0px, 100% 95%, 16% 95%)" }}
            >
          ...
          >
            <a class="text-gray-900 hover:text-yellow-500 " href="">
              About
            </a>
            <a class="text-gray-900 hover:text-yellow-500 " href="">
              Blog
          ...
          <div class="hidden items-center lg:flex">
            <div
              className="py-16 bg-yellow-600 z-50"
              style={{ clipPath: "polygon(4px 24px, 50% -50px, 100% 100%, 32% 100%)" }}
            >
              <a
                href="#"
