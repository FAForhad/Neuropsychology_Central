        ...
        <div>
            <footer aria-label="Site Footer" class="bg-white lg:grid lg:grid-cols-5">
                <div class="relative block h-32 lg:col-span-2 lg:h-full">
                    <img
                        src="https://img.freepik.com/free-vector/creative-angel-with-long-wings-tshirt-design-hand-drawn-sketch-vector-illustration_460848-14656.jpg?w=740&t=st=1675071674~exp=1675072274~hmac=9a15931e2ed39a5bb9d3f6c0a69519540471081dcd9ee829b48abe91ffb8ac56"
                        alt=""
                        class="absolute inset-0 object-cover w-full h-full p-8"
                    />
                </div>
